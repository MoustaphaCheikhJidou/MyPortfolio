...
\begin{itemize}
  ...
  \item Exploitation et structuration de séries macroéconomiques et monétaires issues de la BCM, de l'ANSADE et de bases internationales pour la calibration et les simulations.
...
\begin{itemize}
  \item Modélisation économétrique de la dynamique de croissance de la Mauritanie à l'aide d'un modèle ARDL sous R. \href{https://github.com/MoustaphaCheikhJidou/ARDL-Growth-Mauritania}{GitHub}.
\end{itemize}
\divider
...
{\footnotesize R \textbullet{} Stata \textbullet{} Eviews \textbullet{} GAMS \textbullet{} Excel \textbullet{} Économétrie \textbullet{} Modélisation DSGE \textbullet{} Méthodes d'enquête}
